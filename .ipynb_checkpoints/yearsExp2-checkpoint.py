...
def YearsExp(yrStart, mnthStart, dyStart, yrEnd, mnthEnd, dyEnd):
    ...
    startDate = datetime(yrStart, mnthStart, dyStart)
    endDate = datetime(yrEnd, mnthEnd, dyEnd)
...
# c. months and years
    ...
    if duration.months and duration.years:
        ...
        print("YearsExp) - months and years")
...
# convert string to int
        ...
        print("YearsExp) - months only ran")
