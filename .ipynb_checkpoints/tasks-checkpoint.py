...
def runFullSearch(id):
    ...
    search_var_list_names, firm_list_names, nbPages, varPts, firmPts, languagePts, MinPoints, searchName, idNb, jobtitle_list_names, jobID = getControlPanelDataStrapi(searchVal)
    ...
    newTest = processSearchGo(flattened, nbPages, varPts, firmPts, languagePts, MinPoints, searchName, searchTerm, firm_list_names, language, idNb, jobtitles, stageTerms, jobID)
